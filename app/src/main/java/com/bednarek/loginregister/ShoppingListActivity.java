    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_recipes:
                Intent recipesAct = new Intent(ShoppingListActivity.this, RecipesActivity.class);
                startActivity(recipesAct);
                break;
            case R.id.nav_products:
                Intent productsAct = new Intent(ShoppingListActivity.this, ProductsActivity.class);
                startActivity(productsAct);
                break;
            case R.id.nav_shopping_list:
                Intent shopping_listAct = new Intent(ShoppingListActivity.this, ShoppingListActivity.class);
